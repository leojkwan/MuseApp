...
-(void)viewDidAppear:(BOOL)animated {
    ...
    [self.containerView fadeInWithDuration:.5 withCompletion:nil];
    ...
    [self setUpKeyboardAvoiding];
     ...
     //        [MBProgressHUD hideHUDForView: [self.navigationController.viewControllers objectAtIndex: 0].view animated:YES];
     ...
     -(void)setUpKeyboard {
         if (self.MUSKeyboardTopBar == nil) {
             ...
             self.entryTitleTextField.inputAccessoryView = self.MUSKeyboardTopBar;
         }
     }
