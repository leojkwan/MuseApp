//
//  MUSMoodCollectionViewController.m
//  Muse
//
...
- (void)viewDidLoad {
    ...
    [self.moods addObjectsFromArray:@[@"yo", @"yoyo", @"Brat", @"Ty",@"yo", @"yoyo", @"Brat", @"Ty",@"yo", @"yoyo", @"Brat", @"Ty",@"yo", @"yoyo", @"Brat", @"Ty",@"yo", @"yoyo", @"Brat", @"Ty",@"yo", @"yoyo", @"Brat", @"Ty"]];
